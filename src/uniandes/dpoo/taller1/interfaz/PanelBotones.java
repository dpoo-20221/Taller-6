...
public class PanelBotones extends JPanel implements ActionListener
{
	...
	public PanelBotones(InterfazLibreria interfazLibreria)
	{
		...
		agregarBoton(CALIFICACION, "Dar promedio de calificación", "./data/iconos/estrella.png");
		agregarBoton(CATEGORIA_MAS_LIBROS, "Dar la categoría con más libros", "./data/iconos/libreria.png");
		agregarBoton(CONTAR_SIN_PORTADA, "Contar libros sin portada", "./data/iconos/libro.png");
		agregarBoton(CATEGORIA_MEJOR, "Dar la mejor categoría", "./data/iconos/premio.png");
		agregarBoton(AUTOR_VARIAS_CATEGORIAS, "Buscar un autor con varias categorías", "./data/iconos/autor.png");
